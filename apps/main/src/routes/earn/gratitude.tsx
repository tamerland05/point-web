...
function RouteComponent() {
  ...
  return (
    <ShowMainButton onClick={goToMap} title={t("EARN.TASKS.GRATITUDE_TITLE")}>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 flex w-full flex-col p-4">
        ...
        <div className="mb-1 text-center font-semibold text-title-2">{t("EARN.GRATITUDE.TITLE")}</div>
        <div className="mx-10 mb-7 text-center text-text-secondary">{t("EARN.GRATITUDE.SUBTITLE")}</div>

        <div>
          <h2 className="px-4 text-caption-3 text-text-secondary uppercase">{t("EARN.GRATITUDE.BONUS_AMOUNT")}</h2>
          ...
          <div className="mt-3 overflow-hidden rounded-2xl border border-[#CBCBD0]">
            <div className="grid grid-cols-2 divide-x divide-[#CBCBD0]">
              <div className="px-4 py-2.5">{t("EARN.GRATITUDE.EARNED")}</div>
